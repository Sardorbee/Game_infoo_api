...
class GameServiceAdapter extends TypeAdapter<GameService> {
  @override
  final int typeId = 1;

  @override
  GameService read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, GameService obj) {
    writer
      ..writeByte(11)
      ..writeByte(0)
      ..write(obj.id)
